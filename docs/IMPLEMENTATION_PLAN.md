...
| S21    | Calendar Polish + Monthly Rate (Schema v3)                        | FE     | V2    | L-XL | IN_PROGRESS | —     | S19, S20            | rate-type-monthly, dexie-v3, drive-snapshot-v3, earnings-monthly, name-only-chips, weekview-borders       |
