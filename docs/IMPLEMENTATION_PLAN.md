...
| S20    | Reports Overhaul (Filters, Pickers, Table, GC Edit Regression)    | FE     | V2    | L    | IN_PROGRESS | —     | S19                 | month-picker, week-picker, sticky-date-fix, reset-red, reset-cards, scrollable-chips, gc-patch-regression |
