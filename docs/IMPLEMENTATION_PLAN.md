...
| S19    | Cards UX + Visual Unification + Header/Bottom-bar + PWA Icon      | FE     | V2    | M-L  | IN_PROGRESS | —     | S18                 | numeric-input, 12-color-palette, bg-color-cards, icon-only-add, dropdown-menu, scrollbar-none, pwa-icon   |
| S20    | Reports Overhaul (Filters, Pickers, Table, GC Edit Regression)    | FE     | V2    | L    | PENDING     | —     | S19                 | month-picker, week-picker, sticky-date-fix, reset-red, reset-cards, scrollable-chips, gc-patch-regression |
| S21    | Calendar Polish + Monthly Rate (Schema v3)                        | FE     | V2    | L-XL | PENDING     | —     | S19, S20            | rate-type-monthly, dexie-v3, drive-snapshot-v3, earnings-monthly, name-only-chips, weekview-borders       |
