...
| S31    | Audit Remediation: Payment Correctness, Data Integrity & Cleanup  | FE     | V3    | M    | IN_PROGRESS | local | S27, S28, S29       | payment-epsilon, ledger-cent-round, payment-cascade, idempotent-calendar-create, atomic-updates, prefs-calendarId-keep, snapshot-guard, 412-tests, restore-e2e, token-refresh-tests, offline-e2e, coop-header, readme-refresh |
