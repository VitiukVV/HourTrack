...
| S19    | Cards UX + Visual Unification + Header/Bottom-bar + PWA Icon      | FE     | V2    | M-L  | PENDING | —     | S18                 | numeric-input, 12-color-palette, bg-color-cards, icon-only-add, dropdown-menu, scrollbar-none, pwa-icon   |
